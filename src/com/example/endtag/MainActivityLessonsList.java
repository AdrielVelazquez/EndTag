...
public class MainActivityLessonsList extends Activity {
	...
	private class MyViewPagerAdapter extends PagerAdapter {
		...
		@Override
		public int getCount() {
			return 3; // Number of pages usually set with .length() or .size()
		}
		...
		public Object instantiateItem(View collection, int position) {
			final LayoutInflater inflater = (LayoutInflater) MainActivityLessonsList.this
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			TextView tv = new TextView(MainActivityLessonsList.this);
			switch (position) {
			case 0:
				View v1 = inflater.inflate(R.layout.expanderhtml, null, false);
				ExpandableListView elv2 = (ExpandableListView) v1
						.findViewById(R.id.elv2);
				if (true) { // if the size of the data source is greater than 0
							// do the following
					MainActivityLessonsList.this.mAdapter = new BaseExpandableListAdapter() {
						...
						public int getChildrenCount(int groupPosition) {
							return 5; // Size of children usually taken from
										// .length or .size()
						}
						...
						public int getGroupCount() {
							return 5; // Groups count usually taken from
										// .length or .size()
						}
					...
					elv2.setAdapter(MainActivityLessonsList.this.mAdapter);
			...
			case 1: // Full ExpandableList code here
				...
				if (true) { // if the size of the data source is greater than 0
					...
					elv1.setAdapter(MainActivityLessonsList.this.mAdapter);

					((ViewPager) collection).addView(v, 0);
					return v;
				}
			default:
				tv.setText("Daily Challenge ");
